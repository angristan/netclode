...
export type ControlPlaneMessage = Message<"netclode.v1.ControlPlaneMessage"> & {
  ...
  message: {
     ...
     *
     * @generated from field: netclode.v1.UpdateCodexAuth update_codex_auth = 10;
     */
    value: UpdateCodexAuth;
 ...
 *
 * @generated from message netclode.v1.UpdateCodexAuth
 */
export type UpdateCodexAuth = Message<"netclode.v1.UpdateCodexAuth"> & {
  /**
...
/**
 * Describes the message netclode.v1.UpdateCodexAuth.
 * Use `create(UpdateCodexAuthSchema)` to create a new message.
 */
export const UpdateCodexAuthSchema: GenMessage<UpdateCodexAuth> = /*@__PURE__*/
  messageDesc(file_netclode_v1_agent, 22);
